...
module Vantiv
  ...
  def self.auth(amount:, payment_account_id:, customer_id:, reference_number:)
  ...
  def self.auth_capture(amount:, payment_account_id:, customer_id:, reference_number:)
    body = Api::RequestBody.for_auth_or_sale(
      amount: amount,
      reference_number: reference_number,
      customer_id: customer_id,
  ...
  def self.refund(amount:, payment_account_id:, customer_id:, reference_number:)
